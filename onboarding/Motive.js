...
export default function Motive({ navigation }) {
  ...
  const onIconPressNext = () => {
    navigation.push('TableClass', { text: 'TableClass' })
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        ...
        style={styles.image}
      />
      <Text style={styles.category}>Your Motive</Text>
      <View style={styles.selection}>
        {category.motive.map((item) => {
          return (
            <Pressable
              style={
                item.value === motive ? styles.selected : styles.unselected
              }
