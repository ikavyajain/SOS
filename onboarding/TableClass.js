...
export default function TableClass({ navigation }) {
  ...
  const onIconPressNext = () => {
    navigation.push('Seats', { text: 'Seats' })
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        ...
        style={styles.image}
      />
      <Text style={styles.category}>Table Class</Text>
      <View style={styles.selection}>
        {category.class.map((item) => {
          return (
            <Pressable
              style={
                item.value === tableclass ? styles.selected : styles.unselected
              }
